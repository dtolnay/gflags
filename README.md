...
[`gflags::define!`]: https://docs.rs/gflags/0.0/gflags/macro.define.html
...
[`gflags::parse()`]: https://docs.rs/gflags/0.0/gflags/fn.parse.html
...
[`gflags::print_help_and_exit()`]: https://docs.rs/gflags/0.0/gflags/fn.print_help_and_exit.html
...
[`gflags::custom::Value`]: https://docs.rs/gflags/0.0/gflags/custom/trait.Value.html
